  ...
  Sexy = {
    ...
    messageBox: function(type, message, properties, input) {
        ...
        else if(type == 'confirm')
        {
            ...
            $('#'+this.options.name+'-Buttons').append('<input class="button" id="BoxConfirmBtnOk" type="submit" /> <input class="button" id="BoxConfirmBtnCancel" type="submit" />');
        ...
        else if(type == 'prompt')
        {
            ...
            $('#'+this.options.name+'-Buttons').append('<input class="button" id="BoxPromptBtnOk" type="submit" /> <input class="button" id="BoxPromptBtnCancel" type="submit" />');
