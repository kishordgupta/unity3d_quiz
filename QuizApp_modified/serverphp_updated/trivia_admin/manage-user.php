...
$listfile = "manage-user.php";
$userdetailsfile = "user-details.php";
                ...
                <div class="content-box"><!-- Start Content Box -->
                    ...
                    <div class="content-box-content">
                        ...
                        <div class="tab-content default-tab" id="tab1">
                            ...
                            <table>
                                <thead>
                                    <tr><td colspan="4"><?php include ("order.php"); ?></td></tr>
                                    <tr>
                                        <td colspan="4">
                            ...
                            <?php if (mysql_num_rows($result[0]) > 0) { ?>
                                        ...
                                        <tbody>
                                            ...
                                            while ($val = mysql_fetch_array($result[0])) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- Icons -->
                                                        <a href="<?= $userdetailsfile; ?>?id=<?= $val['id']; ?>" title="<?= $pagename; ?> Details" rel="facebox"><img src="images/icons/1details.png" alt="<?= $pagename; ?> Details" /></a>
                                                        <a href="javascript:void(0);" style="cursor:pointer" onclick="del_confirm('<?= $pagename ?>?', '<?= $listfile ?>?mode=delete&id=<?= $val['id'] ?><?= $query_string ?>')" title="Delete <?= $pagename ?>"><img src="images/icons/cross.png" alt="Delete <?= $pagename ?>" /></a> 
                                                    </td>
                                                </tr>
                                                <?php
                                                $cnt++;
