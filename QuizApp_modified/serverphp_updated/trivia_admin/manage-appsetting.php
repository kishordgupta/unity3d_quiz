<?php
	...
	$listfile = "manage-appsetting.php";	
	...
	if (isset ($_REQUEST['search']) && $_REQUEST['search'] != "")
	{
		...
		$where = "like '%".$search."%' or message like '".$search."%' ";
	...
	{
		$ord=$_REQUEST['ord'];
		$where = "like '$ord%' or message like '$ord%'";
                            ...
                            <form action="" method="post" name="data_list" id="data_list">
                            	<thead style="border-top:#CCC 1px solid">
                                    <tr>
                                       ...
                                       <th width="10%">Correct Answer Message</th>
                                       <th width="10%">Wrong Answer Message</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td><?=$val['correct_message']?></td>
                                       <td><?=$val['wrong_message']?></td>  
